...
function DivCardList(){
    ...
    description: "Creación de tests unitarios con Jest para comprobar"+
    ...
    const cardData7 = {
        ...
        description: "Revisión de prácticas seguras en aplicaciones web "
    ...
    const cardData9 = {
        ...
        subtitle: "Bases de Datos",
        description: "Resolución de consultas complejas usando funciones"+
        "de agregación y subconsultas.",
        date: "10-10-2025",
        color: "#F5C542" // amarillo
    };
    ...
    const cards = [cardData1, cardData2, cardData3, cardData4,
    cardData5 ,cardData6 ,cardData7 ,cardData8 ,cardData9 ,cardData10 ,cardData11 ,cardData12];
